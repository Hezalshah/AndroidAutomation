...
class TestPerfectFor(unittest.TestCase):
    def setUp(self):
    ...
    def test_perfectfor_station(self):
        ...
        time.sleep(2)
        self.driver.execute_script("mobile: tap", {"tapCount": 1, "touchCount": 1, "duration": 0.5, "x": 605, "y": 561})
        time.sleep(2)

if __name__ == '__main__':
    suite = unittest.TestLoader().loadTestsFromTestCase(TestPerfectFor)
